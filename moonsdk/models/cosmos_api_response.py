...
class CosmosAPIResponse(BaseModel):
    """
    CosmosAPIResponse
    """ # noqa: E501
    success: StrictBool
    message: StrictStr
    data: Optional[CosmosTransactionOutput] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": CosmosTransactionOutput.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
