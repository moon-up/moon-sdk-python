...
class AaveReservesAPIResponse(BaseModel):
    """
    AaveReservesAPIResponse
    """ # noqa: E501
    success: StrictBool
    message: StrictStr
    data: Optional[AaveReservesData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": AaveReservesData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
