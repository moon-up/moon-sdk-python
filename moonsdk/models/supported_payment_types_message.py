...
class SupportedPaymentTypesMessage(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "googlepay": PaymentType.from_dict(obj.get("googlepay")) if obj.get("googlepay") is not None else None,
            "applepay": PaymentType.from_dict(obj.get("applepay")) if obj.get("applepay") is not None else None,
            "creditcard": PaymentType.from_dict(obj.get("creditcard")) if obj.get("creditcard") is not None else None
        })
        return _obj
