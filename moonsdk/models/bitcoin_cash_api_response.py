...
class BitcoinCashAPIResponse(BaseModel):
    """
    BitcoinCashAPIResponse
    """ # noqa: E501
    success: StrictBool
    message: StrictStr
    data: Optional[BitcoinCashTransactionOutput] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": BitcoinCashTransactionOutput.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
