...
class AaveInput(BaseModel):
    ...
    lending_pool: Optional[StrictStr] = None
    amount: Optional[StrictStr] = None
    atoken_to_redeeem: Optional[StrictStr] = None
    ref_code: Optional[StrictStr] = None
    interest_rate_mode: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["to", "data", "input", "value", "nonce", "gas", "gasPrice", "chain_id", "encoding", "EOA", "contract_address", "token_id", "token_ids", "approved", "broadcast", "lending_pool", "amount", "atoken_to_redeeem", "ref_code", "interest_rate_mode"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "lending_pool": obj.get("lending_pool"),
            "amount": obj.get("amount"),
            "atoken_to_redeeem": obj.get("atoken_to_redeeem"),
            "ref_code": obj.get("ref_code"),
