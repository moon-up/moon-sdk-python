...
class Quote(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "ramp": obj.get("ramp"),
            "availablePaymentMethods": [AvailablePaymentMethod.from_dict(_item) for _item in obj.get("availablePaymentMethods")] if obj.get("availablePaymentMethods") is not None else None,
