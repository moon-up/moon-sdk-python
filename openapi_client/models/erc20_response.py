...
class Erc20Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["moon_scan_url", "transaction_hash", "signed_transaction", "signed_message", "raw_transaction", "signature", "transaction", "userOps", "userop_transaction", "name", "symbol", "decimals", "totalSupply", "contract_address", "balanceOf", "allowance"]
