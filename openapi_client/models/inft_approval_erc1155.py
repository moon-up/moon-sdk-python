...
class INFTApprovalERC1155(BaseModel):
    """
    INFTApprovalERC1155
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["transactionHash", "contract", "logIndex", "account", "operator", "approved", "tokenContractType", "tokenName", "tokenSymbol"]
