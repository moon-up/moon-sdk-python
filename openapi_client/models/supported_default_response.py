...
class SupportedDefaultResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "defaults": SupportedDefaultResponseDefaults.from_dict(obj.get("defaults")) if obj.get("defaults") is not None else None,
            "recommended": SupportedDefaultResponseDefaultsId.from_dict(obj.get("recommended")) if obj.get("recommended") is not None else None
        })
        return _obj
