...
class Erc1155Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["moon_scan_url", "transaction_hash", "signed_transaction", "signed_message", "raw_transaction", "signature", "transaction", "userOps", "userop_transaction", "balance_of", "balance_of_batch"]
